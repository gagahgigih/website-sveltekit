...
<div id="productphotography" class="scroll-smooth bg-blacky  ">
    <div class="w-screen md:h-screen flex items-center flex-col gap-4 lg:gap-8 p-4 ">
        ...
        <div class="font-inter md:w-1/2 bg-[#0A0808]/80 p-8 rounded-2xl flex flex-col justify-center text-center font-bold shadow-xl shadow-black">
            <div>
                <h3 class="text-white text-xl border-b">Product Photography</h3>
        ...
        <div class="font-inter md:w-1/2 grid grid-cols-2 md:grid-cols-3 gap-4">
            ...
            <div>
                <img class="h-40 w-40 md:w-44 md:h-44 lg:w-56 lg:h-56 2xl:w-62 2xl:h-62 img-studio shadow-md shadow-surface-500/50"  src={img2} alt="" />
            </div>
            <div>
